 ...
 */
class BaseSliderLayout extends DefaultLayoutBase implements ContainerFactoryPluginInterface {
  ...
  protected function getBackgroundOverlayOptions() {
    $options = [
      ...
      'layout--background-overlay layout--background-overlay--blue-fade' => $this->t('Blue Fade'),
      'layout--background-overlay layout--background-overlay--gold-fade' => $this->t('Gold Fade'),
      'layout--background-overlay layout--background-overlay--gray-fade' => $this->t('Gray Fade'),    ];
